...
class NovelWishListCard extends StatelessWidget {
                          ...
                          Positioned(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: Utility.novelStatusColor(novelStatus),
                              ),
                              padding: const EdgeInsets.all(7),
                              child: TextView(
                                label: Utility.novelStatusLabel(novelStatus),
                                fontSize: 10,
                                color: mWhite,
                              ),
                            ),
